...
const BlogDetails = () => {
  ...
  const blog = data.find((blog) => blog.title === slug);
  const dateFromMongoDB = blog.date;
            ...
            <Col lg="8" md="8">
              <div className="blog__details">
                ...
                <h6 className="ps-5 fw-normal">
                  <blockquote className="fs-4" id="quote_style">Quote: "{blog.quote}"</blockquote>
                </h6>
                <p className="section__description" style={{fontSize:16}}>{blog.description}</p>
              </div>
              <hr />
              ...
              {data.map((item) => (
                <div className="recent__blog-post mb-4" key={item.id}>
                  <div className="recent__blog-item d-flex gap-3">
                    ...
                    <h6>
                      <Link to={`/blogs/${item.title}`} className="side_bar_lnk">{blog.title}</Link>
                    </h6>
                  </div>
                </div>
              ))}
